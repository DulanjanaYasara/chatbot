...
#
# NOTE 3: New code modification by Dulanjana Liyanagama for the keyword extraction of WSO2 specified domain
#
...
def generate_candidate_keywords(sentence_list, stopword_pattern, stop_word_list, min_char_length=1, max_words_length=5,
    ...
    for s in sentence_list:
        ...
        tokens = nltk.casual_tokenize(s, preserve_case=False, reduce_len=True)
