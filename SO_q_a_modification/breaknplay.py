...
from SO_q_a_modification import StanfordAPI
...
# TEST CASE
# print entity_extraction("""My Scenario: I have server_1 (192.168.10.1) with  i wso2-ESB and ( Dulanjana ) 123 _ liyanagama server_2 (192.168.10.2) with Glassfish-v3 + web services.
# Problem: I am trying to create a proxy in ESB using the java Web Services, but the created proxy does not respond properly. The log says:  for http or https does not change the result.
# I think I should configure the  but I am having trouble, and don't know what to do. What is the configuration for my scenario? Please help me!
